...
class TestPerformanceBenchmarks:
    ...
    def router_with_cache(self):
        ...
        config = IntentDetectionConfig(use_llm_fallback=False, cache_enabled=True)
        return IntentRouter(config=config)
...
class TestOptimizationValidation:
    ...
    def test_cache_correctness(self):
        ...
        config_no_cache = IntentDetectionConfig(
            use_llm_fallback=False, cache_enabled=False
        )
        config_cache = IntentDetectionConfig(use_llm_fallback=False, cache_enabled=True)
